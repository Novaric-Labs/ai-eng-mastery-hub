...
export const PREFACES = {
  llm: {
    ...
    segments: [
      ...
      { say: "Stateless means you carry the history yourself. Expensive means cost discipline. Probabilistic means you will need evals and guardrails.",
        slide: { kicker: "So...", lines: ["Stateless → you carry the history.", "Probabilistic → you need evals."] } },
  ...
  context: {
    ...
    segments: [
      ...
      { say: "It is about what else is in the room when the model reads them. Agents, retrieval, memory: they are all really this one problem.",
        slide: { kicker: "The real problem", lines: ["Not *how* you phrase it —", "*what else* is in the window."] } },
  ...
  embed: {
    ...
    segments: [
      ...
      { say: "But it is a lossy compression of meaning, tuned for a domain, like an audio codec. And here is the rule people break: you can never compare vectors from two different models.",
        slide: { kicker: "The catch", lines: ["A *lossy codec* for meaning.", "*Never* mix two models' vectors."] } },
  ...
  memory: {
    ...
    segments: [
      ...
      { say: "Because someone engineered a memory system around it: code that decides what to save, and what to bring back later.",
        slide: { kicker: "Engineered, not given", lines: ["Every it-remembers-me", "is a system *you* build."] } },
  ...
  harness: {
    ...
    segments: [
      { say: "Here is a result that should reshape how you think about AI: the same model scored seventy-eight percent in one harness, and forty-two in another.",
        slide: { kicker: "The 36-point gap", lines: ["Same model.", "*78%* versus *42%*."] } },
  ...
  design: {
    ...
    segments: [
      ...
      { say: "So every classic pattern applies, timeouts, retries, circuit breakers, plus new ones: token budgets, eval gates, and semantic caching.",
        slide: { kicker: "Old patterns, new ones", lines: ["Timeouts, retries, fallbacks —", "plus *token budgets* and *eval gates*."] } },
  ...
  lead: {
    ...
    segments: [
      ...
      { say: "Build or buy. Which risks are acceptable. What to tell the executives. How to keep a team current in a field that reinvents itself quarterly.",
        slide: { kicker: "The real job", lines: ["Build or buy? Ship or wait?", "*Judgment*, not syntax."] } },
      ...
      { say: "This module is the judgment layer on top of everything technical you have learned. It is the real differentiator.",
        slide: { kicker: "Leadership Playbook", lines: ["The *judgment* layer.", "Where seniority *shows*."] } },
    ],
  },
  ...
  finetune: {
    ...
    segments: [
      ...
      { say: "Reach for it only with a real volume, latency, or consistency problem, a clean labeled dataset, and a regression suite ready to run.",
        slide: { kicker: "When it is worth it", lines: ["Only with *volume, clean data,*", "and a *regression suite* ready."] } },
  ...
  mlops: {
    ...
    segments: [
      ...
      { say: "Retrofitting this after the first incident always costs more. This module is the instrumentation you build before you ship.",
        slide: { kicker: "AI Observability", lines: ["Instrument it *first*.", "Hear it before *users* do."] } },
    ],
  },
